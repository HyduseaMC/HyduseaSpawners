...
namespace HyduseaMC\HyduseaSpawners\Commands;

use HyduseaMC\HyduseaSpawners\Main;
...
class SpawnerCommand extends PluginCommand
{
    ...
    public function __construct(Main $plugin)
    {
        ...
        $this->setAliases(["HyduseaSpawners"]);
        $this->setDescription("HyduseaSpawners Base Command");
        $this->setPermission("hyduseaspawners.command.spawner");
        $this->plugin = $plugin;
    }
    ...
    {
        if (!$sender->hasPermission("ultramobs.command.spawner")) {
